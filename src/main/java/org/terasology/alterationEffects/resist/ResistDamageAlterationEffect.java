...
public class ResistDamageAlterationEffect implements AlterationEffect {
    ...
    /**
     * This will apply the resist damage effect on the given entity by calling the method {@link #applyEffect(EntityRef, EntityRef, String,
     * float, long)}.
     *
    ...
    /**
     * This will apply the resist damage effect on the given entity. This method will send out an event to the other applicable effect
     * systems so that they can contribute with their own resist damage effect related modifiers.
     *
     * @param instigator The entity who applied the resist damage effect.
     * @param entity The entity that the resist damage effect is being applied on.
     * @param id The ID of this resist damage effect. This is used for determining what damage type to add this resistance to.
     * @param magnitude The magnitude of the resist damage effect.
     * @param duration The duration of the resist damage effect.
     */
