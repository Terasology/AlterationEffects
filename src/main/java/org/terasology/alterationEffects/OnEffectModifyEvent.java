...
public class OnEffectModifyEvent implements ConsumableEvent {
    ...
    /**
     * Create an instance of this event with the given base values, alteration effect, and ID (if needed). Use this one over the other
     * method if you wish to use the updated effects system.
     *
     * @param instigator The entity that caused this effect to be applied or modified.
     * @param entity The entity that the effect is currently on.
     * @param baseMagnitude The base magnitude of this effect.
    ...
    /**
     * Get the shortest duration of all modifiers collected in this list. If one or more had zero duration, zero will be returned.
     * Otherwise, it'll be the shortest duration counted.
     *
    ...
    /**
     * Get the effectID of the effect modifier with the shortest duration. If one or more had zero duration, the last effectID counted that
     * had zero duration will be returned. Otherwise, the effectID associated with the modifier with the shortest duration will be
     * returned.
     *
