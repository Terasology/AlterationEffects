...
public class OnEffectModifyEvent implements ConsumableEvent {
     ...
     * @param id The optional ID of this effect. Only used for effects that support sub-types (like DOT for
     *         example).
     */
    public OnEffectModifyEvent(EntityRef instigator, EntityRef entity, float baseMagnitude, long baseDuration,
    ...
    /**
     * Get the shortest duration of all modifiers collected in this list. If one or more had zero duration, zero will be
     * returned. Otherwise, it'll be the shortest duration counted.
     *
