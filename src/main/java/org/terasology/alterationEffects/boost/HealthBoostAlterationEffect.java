...
public class HealthBoostAlterationEffect implements AlterationEffect {
    ...
    public void applyEffect(EntityRef instigator, EntityRef entity, float magnitude, long duration) {
        ...
        if (modifiedDuration < Long.MAX_VALUE && modifiedDuration > 0 && duration != AlterationEffects.DURATION_INDEFINITE) {
            ...
            delayManager.addDelayedAction(entity,
                    AlterationEffects.EXPIRE_TRIGGER_PREFIX + AlterationEffects.MAX_HEALTH_BOOST + "|" + effectID,
                    modifiedDuration);
        }
        ...
        // add a delayed action to the DelayManager using the old system.
            ...
            delayManager.addDelayedAction(entity,
                    AlterationEffects.EXPIRE_TRIGGER_PREFIX + AlterationEffects.MAX_HEALTH_BOOST, duration);
        }
    ...
    /**
     * This will apply the health boost effect on the given entity by calling the method {@link #applyEffect(EntityRef,
