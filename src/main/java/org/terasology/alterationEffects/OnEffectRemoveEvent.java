...
/**
 * This event is sent to inform all effect-related systems that a particular effect has expired. Or more specifically, a
 * modifier for a particular effect.
 */
public class OnEffectRemoveEvent implements ConsumableEvent {
     ...
     */
    private final float baseMagnitude = 0f;
    /**
     * Base duration of this effect.
     */
    private final long baseDuration = 0;
    /**
     ...
     */
    private final TDoubleList durationModifiers = new TDoubleArrayList();
    /**
     ...
     */
    public OnEffectRemoveEvent(EntityRef instigator, EntityRef entity, AlterationEffect alterationEffect,
                               String effectID, String id) {
     ...
     */
    public OnEffectRemoveEvent(EntityRef instigator, EntityRef entity, AlterationEffect alterationEffect,
                               String effectID, String id, boolean expired) {
        this.instigator = instigator;
        this.entity = entity;
        this.alterationEffect = alterationEffect;
        this.effectID = effectID;
