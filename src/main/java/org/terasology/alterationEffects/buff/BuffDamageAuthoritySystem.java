...
public class BuffDamageAuthoritySystem extends BaseComponentSystem {
    ...
    /**
     * When one of this entity's buff damage effects expire, remove it from the damage buff effects map and recalculate
     * the total magnitude for this damage type.
     *
     ...
     */
    @ReceiveEvent
    public void expireBuffDamageEffect(DelayedActionTriggeredEvent event, EntityRef entity,
                                       BuffDamageComponent component) {
