...
public class CureDamageOverTimeAlterationEffect implements AlterationEffect {
    ...
    /**
     * This will apply the cure DOT effect on the given entity by calling the method {@link #applyEffect(EntityRef,
     * EntityRef, String, float, long)} with the ID being set to "Default".
     *
     ...
     * applicable effect systems informing them that all temporary modifiers that contribute to this particular DOT type
     * will need to be removed. Then, this method will reapply the DOT of that same damage type so that the permanent
     * same type DOT modifiers will be recalculated properly.
     *
     * @param instigator The entity who applied the cure DOT effect.
     * @param entity The entity that the cure DOT effect is being applied on.
    ...
    public void applyEffect(EntityRef instigator, EntityRef entity, String id, float magnitude, long duration) {
        ...
        if (dot.dots.get(id) != null) {
            ...
            entity.send(new OnEffectRemoveEvent(entity, entity, dotAlterationEffect,
                    AlterationEffects.CONSUMABLE_ITEM, id));
